        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @Filmy_Men ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You Sandy ♥️')
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Check PM, I have sent files in pm\n\nअपना मेसेज चेक करीये मैने मूवी भेज दी ही', show_alert=True)
        ...
        await query.answer('♥️ Thank You Sandy ♥️')
        ...
        buttons = [[
            InlineKeyboardButton('🔋 ѕтσяє 🦋', url='https://t.me/SJ_AJ_BACKUP_MOVIE'),
